...
class UserVerify extends UserIndexView{
    public function display($message){
        ...
        <div style="border: 1px solid black; margin: auto; padding: 10px; text-align: center; background-color: rgba(255, 215, 0, 0.85)">
            ...
            ?>
            <div id="button-group">
                <input class="edit-buttons" type="button" value="Menu" onclick='window.location.href = "<?= BASE_URL . "/menu/index/" ?>"'>
                
                <input class="edit-buttons" type="button" value="Home" onclick='window.location.href = "<?= BASE_URL ?>"'>
            </div>
        </div>
