...
<head>
    ...
    <title>Shop Lewies Chinese Bisto</title>
                    ...
                    <div class="card p-2 border-secondary mb-2">
                        ...
                        <div class="card-footer p-1">
                            <form action="" class="form-submit">
                                ...
                                <input type="hidden" class="pname" value="<?= $row['product'] ?>">
                                <input type="hidden" class="pprice" value="<?= $row['category'] ?>">
                                <input type="hidden" class="pimage" value="<?= $row['price'] ?>">
                                <input type="hidden" class="pcode" value="<?= $row['description'] ?>">
